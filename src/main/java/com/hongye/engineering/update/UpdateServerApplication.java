package com.hongye.engineering.update;
...
public class UpdateServerApplication {
    ...
    @Bean
    EngineeringManageFeignClient manageFeignClient() {
        return Feign.builder().encoder(new JacksonEncoder()).decoder(new JacksonDecoder())
                .options(new Request.Options(200000, 350000)).retryer(new Retryer.Default(5000, 5000, 3))
                .target(EngineeringManageFeignClient.class, managePath);
    }
}
